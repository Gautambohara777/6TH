...
<form class="hoteform" method="post" action='updatehotel.php' enctype="multipart/form-data">
	...
	<input type="text" name="latitude" value="<?php echo !empty($latitude) ? $latitude : ''; ?>" placeholder="Latitude" /><br/>
    <input type="text" name="longitude" value="<?php echo !empty($longitude) ? $longitude : ''; ?>" placeholder="Longitude" /><br/>
