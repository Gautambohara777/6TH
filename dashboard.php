		...
		<div class="panel-container">
			<div class="row">
				...
				<div class="col-xs-6 col-md-3 col-lg-3">
					<div class="panel panel-teal panel-widget">
						<div class="row no-padding">
							<em class="icon-line-awesome-bed fs-1 color-blue"></em>
				...
				<div class="col-xs-6 col-md-3 col-lg-3">
					<div class="panel panel-teal panel-widget">
						<div class="row no-padding">
							<em class="icon-material-outline-reorder fs-1 color-red"></em>
				...
				<div class="col-xs-6 col-md-3 col-lg-3">
					<div class="panel panel-blue panel-widget">
						<div class="row no-padding">
							<em class="icon-line-awesome-check-circle fs-1 color-green"></em>
				...
				<div class="col-xs-6 col-md-3 col-lg-3">
					<div class="panel panel-orange panel-widget">
						<div class="row no-padding">
							<em class="icon-line-awesome-check-square-o fs-1 color-magg"></em>
				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-body">
							...
							?>
							<table class="table table-responsive" cellspacing="0" width="100%" id="rooms">
								<thead>
									<tr>
										<th>Room No</th>
										<th>Room Type</th>
