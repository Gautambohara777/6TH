...
function validId(val) {
    if (val ==1){
        ...
        document.getElementById('id_card_no').setAttribute('data-minlength','1');
        ...
        document.getElementById('id_card_no').setAttribute('data-error',"Enter 1 Valid Voter ID Card No");
    }else if(val ==3){
        document.getElementById('id_card_no').setAttribute('type','text');
        document.getElementById('id_card_no').setAttribute('data-minlength','1');
        document.getElementById('id_card_no').setAttribute('placeholder',"RKCS17878A");
        document.getElementById('id_card_no').setAttribute('data-error',"Enter  Valid Pan Card No");
    }else if(val == 4){
        document.getElementById('id_card_no').setAttribute('type','text');
        document.getElementById('id_card_no').setAttribute('data-minlength','1');
